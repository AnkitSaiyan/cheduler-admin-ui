    ...
    this.downloadDropdownControl.valueChanges
      ...
      .subscribe((downloadAs) => {
        ...
        this.downloadSvc.downloadJsonAs(
          ...
          this.filteredPrioritySlots$$.value.map((pr: PrioritySlot) => [pr.startedAt, pr.endedAt? pr.endedAt: `${pr.startedAt}, ${pr.slotEndTime}`, pr.priority]),
  ...
  public copyToClipboard() {
    try {
      ...
      this.filteredPrioritySlots$$.value.forEach((prioritySlot: PrioritySlot) => {
        dataString += `${prioritySlot.startedAt}\t${prioritySlot.endedAt? prioritySlot.endedAt : prioritySlot.startedAt}\t${prioritySlot.priority}\n`;
      });
