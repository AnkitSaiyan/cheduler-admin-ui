...
export const Translate = Object.freeze({
	...
	Error: {
		...
		BackendCodes: {
			[ENG_BE]: {
				...
				MSG_400_APMT_EXCEEDS: 'Appointment exceeds outside hours.',
				MSG_400_DOC_NOT_EDITABLE: 'You can not edit this document',
				MSG_400_SLOT_EXISTS: 'Slot exist in this range',
	...
	SiteManagement: {
		[ENG_BE]: 'Site Management',
		[DUTCH_BE]: 'Pratijkbeheer',
	},
	PracticeHours: {
		[ENG_BE]: 'Practice Hours',
	...
	EmailTemplate: {
		[ENG_BE]: 'Email Template',
		[DUTCH_BE]: 'E-mail Sjabloon',
	},
	LoginFailed: {
		[ENG_BE]: 'Login Failed',
		[DUTCH_BE]: 'Login Failed',
	},
	CompleteProfile: {
