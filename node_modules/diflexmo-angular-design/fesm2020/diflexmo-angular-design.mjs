...
CardComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.12", type: CardComponent, selector: "dfm-card", inputs: { title: "title", showHeader: "showHeader", collapseBody: "collapseBody" }, ngImport: i0, template: `
    <div class="dfm-card">
...
TableRowCellComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "14.2.12", type: TableRowCellComponent, selector: "dfm-table-row-cell", inputs: { propagateClick: "propagateClick", contentAlign: "contentAlign" }, ngImport: i0, template: "<td class=\"cell\">\n    <div class=\"content\" [class.content-right-align]=\"contentAlign === 'right'\"\n        [class.content-non-clickable]=\"!propagateClick\" (click)=\"propagateEvent($event)\">\n        <ng-content></ng-content>\n    </div>\n</td>", styles: [":host-context(.checkbox-cell.checkbox-first-frozen)~:host:nth-child(2) .cell,:host-context(.first-frozen) :host:first-child .cell{box-shadow:12px 0 8px #0000000d;position:sticky;left:0}:host-context(.checkbox-cell) .cell{width:1%;padding-right:0}:host-context(.checkbox-cell)~:host:nth-child(2) .cell{padding-left:0}:host{display:contents;background-color:inherit}:host .cell{font-family:Montserrat;font-style:normal;font-size:14px;line-height:20px;font-weight:400;padding:16px 24px;vertical-align:middle;background-color:inherit}:host .cell .content-right-align{float:right}:host .cell .content-non-clickable{cursor:initial}\n"] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.12", ngImport: i0, type: TableRowCellComponent, decorators: [{
            type: Component,
            args: [{ selector: 'dfm-table-row-cell', template: "<td class=\"cell\">\n    <div class=\"content\" [class.content-right-align]=\"contentAlign === 'right'\"\n        [class.content-non-clickable]=\"!propagateClick\" (click)=\"propagateEvent($event)\">\n        <ng-content></ng-content>\n    </div>\n</td>", styles: [":host-context(.checkbox-cell.checkbox-first-frozen)~:host:nth-child(2) .cell,:host-context(.first-frozen) :host:first-child .cell{box-shadow:12px 0 8px #0000000d;position:sticky;left:0}:host-context(.checkbox-cell) .cell{width:1%;padding-right:0}:host-context(.checkbox-cell)~:host:nth-child(2) .cell{padding-left:0}:host{display:contents;background-color:inherit}:host .cell{font-family:Montserrat;font-style:normal;font-size:14px;line-height:20px;font-weight:400;padding:16px 24px;vertical-align:middle;background-color:inherit}:host .cell .content-right-align{float:right}:host .cell .content-non-clickable{cursor:initial}\n"] }]
        }], propDecorators: { propagateClick: [{
                type: Input
            }], contentAlign: [{
                type: Input
